...
class Search extends Component{
    ...
    render(){
        ...
        const blogResults = this.state.blogResults.map((b,i)=>{
            return <BlogTile key={i} blog={b} />
        })
        const userResults = this.state.userResults.map((u,i)=>{
            return <UserTile key={i} user={u} />
        })
